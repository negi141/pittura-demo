$(function() {
    ...
    var setScene = function() {
        ...
        textureBlur = setTextureBlur($("#change-tex-btn" + texNo));
    ...
    var setTexture = function(btnElem){
        texture  = new THREE.ImageUtils.loadTexture(
            '/pittura-demo/images/tex/window/window' + btnElem.attr("val") + '.jpg');
        // 選択枠
    ...
    var setTextureBlur = function(btnElem){
        textureBlur  = new THREE.ImageUtils.loadTexture(
            '/pittura-demo/images/tex/window/window' + btnElem.attr("val") + '-blur.jpg');
        return textureBlur;
    }
